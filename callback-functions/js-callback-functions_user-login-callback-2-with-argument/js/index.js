...
handleUserLogin((userName) => {
  console.log(`2. Möglichkeit: Welcome ${userName}! You are logged in now.`);
});

// ----------------------------

handleUserLogin(function (userName) {
  console.log(`3. Möglichkeit: Welcome ${userName}! You are logged in now.`);
});
/**
 * You should write a callback function in two 
 * different ways.
In both cases your callback function should 
accept one parameter: "userName".
Use the parameter to log the following message to the console:
"Welcome Jane Doe! You are logged in now."

1. Write a function with the "function" keyword 
named "showWelcomeMessage"
