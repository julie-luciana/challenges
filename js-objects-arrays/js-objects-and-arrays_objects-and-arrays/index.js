...
// EXERCISE 1
// Change the value of the variable nameOfFirstPerson
// to equal the name of the first person.

const nameOfFirstPerson = people[0].name;
console.log(nameOfFirstPerson);

// EXERCISE 2
// Change the value of the variable homersOtherFriends
// to equal the other friends of Homer.

const homersOtherFriends = people[0]["other friends"];
console.log("other friends: ", homersOtherFriends);
// EXERCISE 3
// Change the value of the variable ageOfThirdPerson to equal
// the age of the third person.

const ageOfThirdPerson = people[2].age + 10;
console.log(ageOfThirdPerson);

// EXERCISE 4
// Change the value of the variable
// mothersNameOfSecondPerson to equal the mothers name of the second person.

people[1].parents["mothersName"] = "new name";
const mothersNameOfSecondPerson = people[1].parents.mothersName;
console.log(mothersNameOfSecondPerson);
// EXERCISE 5
// Change the value of the variable animaltypeOfLisasPet
// to equal the type of animal of Lisas pet.

people[3]["pet"] = "cat";
const animaltypeOfLisasPet = people[3].pet;
