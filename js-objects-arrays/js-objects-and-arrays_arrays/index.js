...
// EXERCISE 1
// Modify the array exampleArray so that it contains a number and
//a string.
...
// EXERCISE 3
// Change the value of firstNumber to equal the first value of
//the numbers array using bracket notation.
...
// EXERCISE 5
// Change the value of nestedNumber to equal the fourth
// number of nestedNumbers using bracket notation.

const nestedNumbers = [10, [20, 30, [40, 50]]];

const nestedNumber = nestedNumbers[1][2][0];
console.log("Solution ex 5:");
console.log(nestedNumber);

// EXERCISE 6
// Put "rat" onto the end of petsWithPush variable by
...
// EXERCISE 8
// Put "hamster" onto the start of unshiftedPets
//variable by using the array method unshift.
